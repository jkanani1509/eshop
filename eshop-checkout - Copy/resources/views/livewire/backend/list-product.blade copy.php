            ...
            <tbody>
                @foreach ($records as $record)
                    <tr>
                        ...
                        <td>{{ $record->title }}</td>
                        <td>{{ $record->slug }}</td>
                        <td>{{ $record->cat_info->title }}</td>
                        <td>
                            @if ($record->photo)
                                {{-- <img src="{{$category->photo}}" class="img-fluid" style="max-width:80px" alt="{{$category->photo}}"> --}}
                                <img src="{{ asset('upload/category/' . $record->photo) }}" class="img-fluid"  style="max-width:80px" alt="avatar.png">
                            @else
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content text-bg-dark">
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="{{ $editModel ? 'update()' : 'store()' }}" enctype="multipart/form-data" enctype="multipart/form-data">
                            <div class="div row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select wire:model.lazy="cat_id" class="form-control">
                                            ...
                                            @foreach(Helper::getAllPerentCategory() as $cat)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select  wire:model.lazy="brand_id" class="form-control">
                                            ...
                                            @foreach(Helper::getAllBrands() as $rec)
                                                <option value="{{$rec->id}}" {{ $rec->id == $brand_id  ? 'selected' : '' }}>{{$rec->title}}</option>
                                            @endforeach
                                        </select>
                                        <span class="text-danger">
                                            @error('brand_id')
                            ...
                            <div class="div row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ $id }}
                                        <input type="text" wire:model.lazy="price" class="form-control" id="price"
                                            aria-describedby="priceHelp" placeholder="Enter Price" autofocus>
                                        @error('price')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" wire:model.lazy="discount" class="form-control" id="discount"
                                            aria-describedby="discountHelp" placeholder="Enter Stock">
                                        @error('discount')
                                            <span class="error text-red">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="div row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select  wire:model.lazy="size" class="form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" wire:model.lazy="stock" class="form-control" id="stock"
                            ...
                            <div class="form-group">
                                ...
                                <div class="div row">
                                    <div class="col-md-6">
                                        ...
                                        <img src="{{ asset('upload/category/' . $oldphoto) }}" class="img-fluid"  style="max-width:80px" alt="avatar.png">
