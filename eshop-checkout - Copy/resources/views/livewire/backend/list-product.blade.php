            ...
            <tbody>
                @foreach ($records as $record)
                    <tr>
                        ...
                        <td>{{ $record->title }}</td>
                        <td>{{ $record->slug }}</td>
                        <td>{{ $record->cat_info->slug }}</td>
                        <td>
                            @if ($record->photo)
                                {{-- <img src="{{$category->photo}}" class="img-fluid" style="max-width:80px" alt="{{$category->photo}}"> --}}
                                <img src="{{ asset('upload/products/' . $record->photo) }}" class="img-fluid"  style="max-width:80px" alt="avatar.png">
                            @else
                            ...
                            <div class="form-group">
                                ...
                                <div class="div row">
                                    <div class="col-md-6">
                                        ...
                                        <img src="{{ asset('upload/products/' . $oldphoto) }}" class="img-fluid"  style="max-width:80px" alt="avatar.png">
