                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        ...
                        <li><i class="ti-location-pin"></i> <a href="#">Track Order</a></li>
                            ...
                            @else
                                <li><i class="ti-power-off"></i><a href="{{ route('login') }}">Login /</a> <a href="#">Register</a></li>
                            @endauth
                        </ul>
                    </div>
                    <!-- End Top Right -->
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-12">
                    <div class="right-bar">
                            ...
                            <!-- Shopping Item -->
                                ...
                                <div class="shopping-item">
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount">12345</span>
                                        </div>
                                        <a href="" class="btn animate">VIEW WISHLIST</a>
                                    </div>
                                </div>
                        ...
                        <div class="sinlge-bar shopping">
                            <a href="#" class="single-icon"><i class="ti-bag"></i> <span class="total-count">10</span></a>
                            <!-- Shopping Item -->
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
